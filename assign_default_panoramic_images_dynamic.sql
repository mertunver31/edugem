-- =====================================================
-- ASSIGN DEFAULT PANORAMIC IMAGES TO USER (DYNAMIC VERSION)
-- =====================================================
-- Bu dosya kullanıcılara default panoramic resimleri atayan fonksiyonları içerir
-- Supabase URL'sini otomatik olarak alır
...
BEGIN
    ...
    -- Supabase URL'sini al (bucket'tan)
    SELECT 
        'https://' || 
    ...
    LOOP
        -- Public URL oluştur
        public_url := bucket_url || file_record.file_name;
