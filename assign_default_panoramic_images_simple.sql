-- =====================================================
-- ASSIGN DEFAULT PANORAMIC IMAGES TO USER (SIMPLE VERSION)
-- =====================================================
...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO panoramic_images (
            ...
            'https://pdnmhbqxvkdfjvufjvff.supabase.co/storage/v1/object/public/default-panoramic-images/' || file_record.file_name,
